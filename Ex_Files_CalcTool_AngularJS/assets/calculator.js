...
(function(){
    console.log('hi');
    // application variable (ng-app="myCalculator")
    var app = angular.module('myCalculator',[]);

    // $scope service is initiated by the function (ng-controller="CalculatorController")
    app.controller('CalculatorController',['$scope',function($scope){
        
        //lumen_options is a variable/array
